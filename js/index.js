...
(function () {
    ...
    function onDeviceReady() {
		...
		// funzione redirect to social
		let sbs = document.getElementById('socialbtn');
		if(sbs != null)
		{
			sbs.addEventListener("click", function(event)
			{
				var inAppBrowser = window.open('https://www.myturing.it/it/Blog/treeffe', '_system', 'location=yes hidde=yes');
